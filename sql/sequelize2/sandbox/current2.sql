--drop table if EXISTS report_dev.test2 create table report_dev.test2 as 
with x1 as (
    select договор_ид,
        начисл_осн,
        погаш_осн,
    ...
    where дата between '2022-11-01'::date and '2022-11-30'::date
        and договор_ид = 358
),
x2 as (
    select договор_ид,
